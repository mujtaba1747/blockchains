...
func init() {
	proto.RegisterType((*MsgCreateName)(nil), "cosmonaut.nameservice.nameservice.MsgCreateName")
	proto.RegisterType((*MsgCreateNameResponse)(nil), "cosmonaut.nameservice.nameservice.MsgCreateNameResponse")
...
var fileDescriptor_df4dec9b515ec245 = []byte{
	...
	,
	...
	0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0xb8, 0xd1, 0xfa, 0xc8, 0x39, 0xb8, 0x02, 0x85, 0x57, 0x52,
	0x59, 0x90, 0x5a, 0x9c, 0xc4, 0x06, 0xce, 0xd3, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x20,
	0x31, 0x1f, 0xd7, 0xeb, 0x03, 0x00, 0x00,
}
...
func (c *msgClient) CreateName(ctx context.Context, in *MsgCreateName, opts ...grpc.CallOption) (*MsgCreateNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmonaut.nameservice.nameservice.Msg/CreateName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmonaut.nameservice.nameservice.Msg/CreateName",
	}
