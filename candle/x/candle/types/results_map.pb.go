...
func (m *ResultsMap) GetBidId() uint64 {
	if m != nil {
		return m.BidId
	}
	return 0
...
var fileDescriptor_b1f8dea10f26f6ba = []byte{
	...
	0xc1, 0xa2, 0xc0, 0xa8, 0xc1, 0x12, 0x04, 0xe1, 0x38, 0x39, 0x9c, 0x78, 0x24, 0xc7, 0x78, 0xe1,
	0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x13, 0x1e, 0xcb, 0x31, 0x5c, 0x78, 0x2c, 0xc7, 0x70,
	0xe3, 0xb1, 0x1c, 0x43, 0x94, 0x5a, 0x7a, 0x66, 0x49, 0x46, 0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae,
	0x3e, 0xd8, 0xed, 0xfa, 0x50, 0xbf, 0x55, 0xc0, 0x18, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c,
	0x60, 0x47, 0x1b, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xea, 0xbc, 0x27, 0x66, 0xfb, 0x00, 0x00,
	0x00,
}
...
func (m *ResultsMap) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.BidId != 0 {
		i = encodeVarintResultsMap(dAtA, i, uint64(m.BidId))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Winner) > 0 {
...
func (m *ResultsMap) Size() (n int) {
	...
	if m.BidId != 0 {
		n += 1 + sovResultsMap(uint64(m.BidId))
	}
	return n
}
