...
type ResultsMap struct {
	...
	EndHeight int64  `protobuf:"varint,5,opt,name=endHeight,proto3" json:"endHeight,omitempty"`
}
...
func (m *ResultsMap) GetEndHeight() int64 {
	if m != nil {
		return m.EndHeight
	}
	return 0
...
var fileDescriptor_b1f8dea10f26f6ba = []byte{
	...
	0x29, 0x91, 0xf4, 0xfc, 0xf4, 0x7c, 0xb0, 0xbc, 0x3e, 0x88, 0x05, 0x51, 0xaa, 0xd4, 0xc1, 0xc8,
	0xc5, 0x15, 0x04, 0x31, 0xc0, 0x37, 0xb1, 0x40, 0x48, 0x82, 0x8b, 0x3d, 0xb9, 0x28, 0x35, 0xb1,
	0x24, 0xbf, 0x48, 0x82, 0x51, 0x81, 0x51, 0x83, 0x33, 0x08, 0xc6, 0x15, 0x12, 0xe1, 0x62, 0xcd,
	0xcc, 0x4b, 0x49, 0xad, 0x90, 0x60, 0x02, 0x8b, 0x43, 0x38, 0x42, 0x62, 0x5c, 0x6c, 0xe5, 0x99,
	0x79, 0x79, 0xa9, 0x45, 0x12, 0xcc, 0x60, 0x61, 0x28, 0x0f, 0xa4, 0x3a, 0x29, 0x33, 0xc5, 0x33,
	0x45, 0x82, 0x05, 0xa2, 0x1a, 0xcc, 0x11, 0x92, 0xe1, 0xe2, 0x4c, 0xcd, 0x4b, 0xf1, 0x48, 0xcd,
	0x4c, 0xcf, 0x28, 0x91, 0x60, 0x55, 0x60, 0xd4, 0x60, 0x0e, 0x42, 0x08, 0x38, 0x39, 0x9c, 0x78,
	...
	0x5e, 0x72, 0x7e, 0xae, 0x3e, 0xd8, 0x6b, 0xfa, 0x50, 0xaf, 0x57, 0xc0, 0x18, 0x25, 0x95, 0x05,
	0xa9, 0xc5, 0x49, 0x6c, 0x60, 0x3f, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x2b, 0xb5, 0xbd,
	0x88, 0x1a, 0x01, 0x00, 0x00,
}
...
func (m *ResultsMap) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.EndHeight != 0 {
		i = encodeVarintResultsMap(dAtA, i, uint64(m.EndHeight))
		i--
		dAtA[i] = 0x28
	}
	if len(m.BidId) > 0 {
...
func (m *ResultsMap) Size() (n int) {
	...
	if m.EndHeight != 0 {
		n += 1 + sovResultsMap(uint64(m.EndHeight))
	}
	return n
}
