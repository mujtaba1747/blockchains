...
import HelloCandleHelloCandleCandle from './hello/candle/hello.candle.candle';
export default {
    ...
    HelloCandleHelloCandleCandle: load(HelloCandleHelloCandleCandle, 'hello.candle.candle'),
};
